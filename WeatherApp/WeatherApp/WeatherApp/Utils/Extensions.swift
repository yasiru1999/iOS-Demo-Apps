...
//  WeatherApp
//
//  Created by YASIRU JAYASEKARA on 2025-08-25.
//
...
extension Color {
    ...
    static let tabBar_Border = Color("Tab Bar Border").opacity(0.5)
    static let forecastCard_Background = Color("Forecast Card Background")
